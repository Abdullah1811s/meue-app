...
//     { x: number; y: number; size: number; color: string; rotation: number; speed: number }[]
//   >([]);
  ...
  export default function UserDashboard() {
    ...
    useEffect(() => {
      socket.on("visibilityChanged", (data) => {
        ...
        console.log(`📢 Raffle ${data.updatedRaffle} visibility changed!`);
        const updatedRaffleId = data.updatedRaffle._id;
        const newVisibility = data.updatedRaffle.isVisible;
        console.log("raffle:", data.updatedRaffle)
        setUpcomingRaffles(prev => {
          ...
          if (newVisibility) {
            ...
            console.log("the raffle ot update is ", raffleToUpdate);
    ...
    const startDrawAnimation = (raffle: UpcomingRaffle) => {
      ...
      // Create an entry pool for the animation
    ...
    const finalizeDraw = (raffle: UpcomingRaffle, entryPool: User[]) => {
