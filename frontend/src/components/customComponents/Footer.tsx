const Footer = () => {
    return (
      <footer className="bg-black text-white py-10 px-6 md:px-20 border-2 border-red-300 w-full">
        <div className="  grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Left Section */}
          <div>
            <h2 className="text-lg font-bold text-amber-500">THE MENU</h2>
            <p className="mt-2 text-sm">YOUR WORLD, YOUR WAY</p>
            <p className="mt-4 text-sm">Email: <a href="mailto:xyz@gmail.com" className="underline">xyz@gmail.com</a></p>
          ...
          <div className="flex flex-col space-y-2 text-sm">
            ...
            <a href="#" className="hover:underline flex items-center">↗ Instagram</a>
            <a href="#" className="hover:underline flex items-center">↗ Linkedin</a>
          </div>
        </div>
      </footer>
    );
